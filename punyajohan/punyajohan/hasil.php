...
<body>
    ...
    if (empty($pembelian->getNama())) {
        header("location:beli.php?errnama= * Nama belum diisi");
        exit();
    } elseif (empty($pembelian->getAlamat())) {
        header("location:beli.php?erralamat= * Alamat belum diisi");
        exit();
    } elseif (empty($pembelian->getSaldo())) {
        header("location:beli.php?errsaldo= * Saldo belum diisi");
        exit();
    } elseif (empty($pembelian->getJumlah())) {
        header("location:beli.php?errjumlah= * Jumlah belum diisi");
        exit();
    }
