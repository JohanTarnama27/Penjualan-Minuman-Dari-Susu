...
<head>
    ...
    <body>
        ...
        <form action="hasil.php" method="post">
            <label style="color:white; background-color: black;">Nama: </label>
            ...
            ?>
            <br><br>
            <label style="color:white; background-color: black;">Alamat: </label>
            ...
            ?>
            <br><br>
            <label for="saldo" style="color:white; background-color: black;">Total Saldo :</label>
            ...
            ?>
            <br><br>
            <label for="pesanan" style="color:white; background-color: black;">Pesanan Anda :</label>
            ...
            <label style="color:white; background-color: black;">Jumlah</label> <input type="number" name="jumlah"
